/**
 * @file Inf_TicTacToe.h
 * @brief Defines the X-O (Tic-Tac-Toe) specific classes that extend the generic board game framework.
 *
 * This file provides:
 * - `Inf_XO_Board`: A specialized board class for the Tic-Tac-Toe game.
 * - `Inf_XO_UI`: A user interface class tailored to X-O game setup and player interaction.
 */

#ifndef INF_TICTACTOE_H
#define INF_TICTACTOE_H
 ...
 * @see Board
 */
class Inf_XO_Board : public Board<char> {
private:
...
public:
    /**
     * @brief Constructs an Inf_XO_UI object.
     *
    ...
    /**
     * @brief Destructor for Inf_XO_UI.
     */
    ~Inf_XO_UI() {};
